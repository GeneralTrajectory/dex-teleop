...
### Tracker Assignment
Trackers are assigned by serial number (configurable via environment variables):
```bash
export VIVE_TRACKER_LEFT="LHR-XXXXXXXX"   # Your left tracker serial
export VIVE_TRACKER_RIGHT="LHR-YYYYYYYY"  # Your right tracker serial
```
...
- See [TECHNICAL.md](TECHNICAL.md) for detailed tuning options
...
- **Performance optimization**: See [TECHNICAL.md](TECHNICAL.md)
